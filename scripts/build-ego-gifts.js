...
const LIMITED_PACKS_PATH = path.join(__dirname, '..', 'egoGiftLimitedPacks.json');
...
const LIMITED_PACKS = fs.existsSync(LIMITED_PACKS_PATH)
  ? JSON.parse(fs.readFileSync(LIMITED_PACKS_PATH, 'utf8'))
  : {};
